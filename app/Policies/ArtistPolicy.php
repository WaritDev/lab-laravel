...
class ArtistPolicy
{
    ...
    {
        return true; // Any authenticated user can view any artist
    }
    ...
    {
        return true; // Any authenticated user can view specific artist
    }
    ...
    {
        return false; // No one can force delete that artist
    }
}
